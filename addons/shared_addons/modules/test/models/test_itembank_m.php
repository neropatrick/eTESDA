...
class Test_itembank_m extends MY_Model {
	...
	public function getTestTypes(){
        ...
        public function saveToItemBank($courseid,$moduleid,$prompt,$response,$testtype,$difficulty,$category){
            $to_insert= array(
        ...
        public function updateItemBank($itemid,$answer,$question,$category,$difficulty){
            $to_insert = array(
                'response' => $answer,
                'prompt' => $question,
                'category' =>$category,
            ...
            $this->db->where('itemID',$itemid)
            ->update('test_itembank',$to_insert);
                
        }
        
        public function deletePrevChoices($itemid){
            $this->db->delete('testmc_choices', array('itemID' => $itemid)); 
