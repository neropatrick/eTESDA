...
<input type="hidden" name="csrf_hash_name" value="0f8e1b1b2c9e66f5ac094fd62a020dfc">
    ...
    <li> 
       ...
       <table cellspacing="0">
		...
		<tbody>
                    <?php foreach($learners as $learns): ?>
					...
					<td><?php echo $learn['firstname']; ?> <?php echo $learn['middlename']; ?> <?php echo $learn['lastname']; ?></td>
                                        <td><?php echo 'Candidate for Certification'//$learn['email']; ?></td>
                    ...
                    <td style="padding-top:10px;">
						...
						<a href="<?php echo site_url('admin/statistics/courseLearnerProfile/'.$learn['userid']); ?> "  class="button">View Profile</a>
